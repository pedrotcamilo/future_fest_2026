...
-- Junta todos os scripts SQL do projeto (DDL + seed)
-- Ordem: limpeza -> tabelas -> views -> trigger -> indices -> seed
-- Executar em banco PostgreSQL vazio ou existente.
-- ============================================================

-- ------------------------------------------------------------
-- 1. LIMPEZA (testes/limpar_banco.sql)
-- ------------------------------------------------------------
DO $$
DECLARE
    tabelas text;
...
END $$;
-- ------------------------------------------------------------
-- 2. TABELAS (src/sql/*.sql)
-- ------------------------------------------------------------

-- Source: src/sql/materias_primas.sql
...
-- Source: src/sql/fornecedores.sql
...
-- Source: src/sql/historico_consumo.sql
...
-- Source: src/sql/formula_itens.sql
...
-- Source: src/sql/sazonalidade.sql
...
-- Source: src/sql/itens_pedido.sql
...
-- Source: src/sql/ordens_producao.sql
...
-- Source: src/sql/consumo_producao.sql
...
-- Source: src/sql/movimentacoes_estoque.sql
...
-- Source: src/sql/previsoes_consumo.sql
...
-- Source: src/sql/sugestoes_compra.sql
...
-- Source: src/sql/compra_itens.sql
...
-- Source: src/sql/consumo_mensal.sql
...
-- Source: src/sql/proximos_vencimentos.sql
...
-- Source: src/sql/consumo_medio_trigger.sql
-- ============================================================
...
-- ------------------------------------------------------------
-- 6. SEED (identico em docker/init.sql, testes/seed_dados_teste.sql
--    e src/api/services/dependencies/seed_demo.sql)
-- ------------------------------------------------------------
